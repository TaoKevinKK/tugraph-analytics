...
package com.antgroup.geaflow.example.graph.pagila;
...
public class PagliaIncrGraphCompute {

    private static final Logger LOGGER = LoggerFactory.getLogger(PagliaIncrGraphCompute.class);
